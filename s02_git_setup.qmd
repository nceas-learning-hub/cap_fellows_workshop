...
1. Add your personal name, e.g., "Casey O'Hara" - this is just to have a human-readable identifier for others see, not used for authentication or anything.
2. Set up your email address associated to your GitHub account.  THIS is important - this is how GitHub links your changes to your user account.
