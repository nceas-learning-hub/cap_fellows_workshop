...
### Step 1: Owner adds a Collaborator to their repository on GitHub {.unnumbered}
...
### Step 2: Collaborator clones the remote repository {.unnumbered}
...
### Step 3: Collaborator edits files locally {.unnumbered}
...
### Step 4: Collaborator `commit`s, `pull`s, and `push`s {.unnumbered}
...
### Step 5: Owner `pull`s new changes from the remote repo to their local repo {.unnumbered}
...
### Step 6: Owner edits, `commit`s, `pull`s (just in case!) and `push`es {.unnumbered}
...
### Step 7: Collaborator `pull`s new changes from the remote repo to their local repo {.unnumbered}
